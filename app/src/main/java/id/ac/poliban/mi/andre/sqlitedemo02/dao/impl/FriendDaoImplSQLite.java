package id.ac.poliban.mi.andre.sqlitedemo02.dao.impl;
...
import id.ac.poliban.mi.andre.sqlitedemo02.dao.FriendDao;
import id.ac.poliban.mi.andre.sqlitedemo02.domain.Friend;

import static id.ac.poliban.mi.andre.sqlitedemo02.MainActivity.DB_NAME;
import static id.ac.poliban.mi.andre.sqlitedemo02.MainActivity.DB_VERSION;
...
public class FriendDaoImplSQLite extends SQLiteOpenHelper implements FriendDao {
    ...
    public List<Friend> getAllFriends() {
        ...
        while (cursor.moveToNext()) {
            fs.add(new Friend(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6), cursor.getString(7)));
        }
